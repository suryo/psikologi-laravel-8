...
///// MENU \\\\\
//// PROFILE SEKOLAH \\\\
Route::get('profile-griya', [App\Http\Controllers\Frontend\IndexController::class, 'profileSekolah'])->name('profile.griya');
...
Route::middleware('auth')->group(function () {
  ...
  Route::prefix('/')->middleware('role:Admin')->group(function () {
    ...
    Route::resources([
      /// PSIKOLOG \\\
      'backend-pengguna-psikolog' => Backend\Pengguna\PsikologController::class,
      /// USER \\\
