...
class StakeholderController extends Controller
{
    ...
    {
        return view('backend.pengguna.stakeholder.create');
    }
    ...
    {
        $stakeholder = User::with('userDetail')->where('role','Stakeholder')->find($id);
        return view('backend.pengguna.stakeholder.edit', compact('stakeholder'));
    }
