...
use App\Http\Requests\TppsRequest;
use ErrorException;
use Session;
...
class PsikologController extends Controller
{
    ...
    public function index()
    {
        ...
        $psikolog = User::with('userDetail')->where('role','Psikolog')->get();
        return view('backend.pengguna.psikolog.index', compact('psikolog'));
    }
    ...
    {
        return view('backend.pengguna.psikolog.create');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(TppsRequest $request)
    {
        try {
            DB::beginTransaction();
            ...
            DB::commit();
            Session::flash('success','Psikolog Berhasil ditambah !');
            return redirect()->route('backend-pengguna-psikolog.index');
    ...
    {
        $psikolog = User::with('userDetail')->where('role','Psikolog')->find($id);
        return view('backend.pengguna.psikolog.edit', compact('psikolog'));
    }
