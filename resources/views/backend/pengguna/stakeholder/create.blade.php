            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header header-bottom">
                        <h4>Tambah Stakeholder</h4>
                    </div>
                    <div class="card-body">
                        <form action=" {{route('backend-pengguna-stakeholder.store')}} " method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                            ...
                            <a href="{{route('backend-pengguna-stakeholder.index')}}" class="btn btn-warning">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
