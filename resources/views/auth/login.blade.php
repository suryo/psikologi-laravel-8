...
<head>
    ...
    <meta name="author" content="Suryo Atmojo">
    <title>Login Page - DMS</title>
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @endif
                                <img src="Assets/Frontend/img/logo-footer-tp2s.png" alt="" class="mb-2">
                                <h2 class="card-title font-weight-bold mb-1">Welcome to DMS</h2>
